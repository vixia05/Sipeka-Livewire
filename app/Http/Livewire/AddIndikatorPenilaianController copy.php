...
class AddIndikatorPenilaianController extends Component
{
    ...
    public function addEvaluasi($idSub, $index)
    {
        ...
        if($this->formEvaluasi[$idSub] ?? null)
        {
            $this->end[$idSub."-".$index+1] = '';
            $this->start[$idSub."-".$index+1] = '';
            $this->evaluasi[$idSub."-".$index+1]   = '';
    ...
    {
        $this->subIndikators[] = '';
        $this->end["sub".($index+1)."-0"] = '';
        $this->start["sub".($index+1)."-0"] = '';
        $this->evaluasi["sub".($index+1)."-0"] = '';
