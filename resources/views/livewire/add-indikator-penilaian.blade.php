            ...
            <div
                ...
                <div class="flex flex-row gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input wire:model.lazy='indikator' id="title" type="text" class="block mt-1 w-fit" required />
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input wire:model.lazy='nilaiIndikator' id="sumSkor" type="number" class="block w-full mt-1" min="0"
                            max="100" required />
                    </div>
