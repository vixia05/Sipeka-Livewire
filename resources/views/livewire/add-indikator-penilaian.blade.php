...
<div class="py-12">
    <div class="max-w-7xl sm:px-6 lg:px-8">
        ...
        {{--  Indikator Penilaian  --}}
        <div class="px-8 py-6 overflow-hidden bg-white shadow-sm drop-shadow dark:bg-gray-800 sm:rounded-lg">
            {{-- <!-- Header --> --}}
        ...
        {{-- Cakupan Penilaian  --}}
        <div class="px-8 py-6 mt-6 overflow-hidden bg-white shadow-sm drop-shadow dark:bg-gray-800 sm:rounded-lg">
            {{-- <!-- Header --> --}}
            <h4 class="pb-3 mb-4 font-semibold leading-tight text-gray-800 uppercase border-b dark:text-gray-200">
                Cakupan Penilaian
            </h4>
            ...
            <div class="flex flex-row gap-4 pb-6 border-b-2">
                ...
                <div>
                    ...
                    <x-text-input id="subIndikator" type="text" class="block mt-1 w-fit" required />
                </div>
                ...
                <div class="flex flex-col w-full gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="maxSkor" type="number" class="block w-full mt-1" min="0" max="100"
                            required />
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="startRange" type="number" class="block w-full mt-1" min="0"
                                required />
                        </div>
                        ...
                        {{-- <!-- End Range --> --}}
                        <div>
                            <x-text-input id="endRange" type="number" class="block w-full mt-6" min="0"
                                required />
                        </div>
